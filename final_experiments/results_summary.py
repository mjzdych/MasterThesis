...
ablations = ["cn_only", "era5_only", "cn_era5"]
tasks     = ["cc", "bc", "dc", "hw"]
...
for region in regions:
    for task in tasks:
        for abl in ablations:
            run_dir = os.path.join(BASE_OUT, f"{region}_{task}_{abl}")
...
df.to_csv("/gpfs/home2/mzdych/thesis/all_results_summary.csv", index=False)
