...
BASE_OUT  = "/gpfs/home2/mzdych/thesis/experiments_transformer"
...
TASKS = ["DC", "BC"]   # focus on the two most important tasks
...
def run_experiment(exp, clean_ds, times):
    ...
    COEFFS    = exp["COEFFS"]
    suffix    = exp["SUFFIX"]
    run_name  = f"{REGION}_{TASK.lower()}_{suffix}_transformer"
...
for i, exp in enumerate(EXPERIMENTS):
    label = f"{exp['REGION']}_{exp['TASK'].lower()}_{exp['SUFFIX']}_transformer"
